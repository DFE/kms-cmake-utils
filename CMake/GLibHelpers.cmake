...
macro(add_glib_enumtypes outsources outheaders name includeguard)
  ...
  if(MSYS)
    # For MSYS the invocation is essentially the same except for
	# the unescaped double quotes. Ie. the various "   " in the vhead,
	# vprod and vtail parameters have been wiped.
    add_custom_command(
      OUTPUT "${CMAKE_CURRENT_BINARY_DIR}/${name}.c"
      COMMAND ${GLIB-MKENUMS_EXECUTABLE}
